...
describe("financial plugin @ april", () => {
  ...
  test.concurrent("financialMonth", () => {
    expect(dayjs("2022-04-01").financialMonth()).toBe(1);
    expect(dayjs("2022-02-10").financialMonth()).toBe(11);
    expect(dayjs("2022-03-31").financialMonth()).toBe(12);
    expect(dayjs("2022-08-31").financialMonth()).toBe(5);
  });
  ...
  test.concurrent("isSame financialYear", () => {
    expect(dayjs("2022-04-21").isSame("2022-06-30", "financialYear")).toBe(
      true
    );
    expect(dayjs("2021-03-21").isSame("2022-06-30", "financialYear")).toBe(
      false
    );
    expect(dayjs("2022-12-21").isSame("2023-04-01", "financialYear")).toBe(
      false
    );
  });

  test.concurrent("isSame financialQuarter", () => {
    expect(dayjs("2022-04-21").isSame("2022-06-30", "financialQuarter")).toBe(
      true
    );
    expect(dayjs("2021-03-21").isSame("2022-06-30", "financialQuarter")).toBe(
      false
    );
    expect(dayjs("2022-12-21").isSame("2023-10-01", "financialQuarter")).toBe(
      true
    );
  });
});
...
describe("financial plugin @ january", () => {
  ...
  test.concurrent("financialMonth", () => {
    expect(dayjs("2022-04-01").financialMonth()).toBe(4);
    expect(dayjs("2022-02-10").financialMonth()).toBe(2);
    expect(dayjs("2022-03-31").financialMonth()).toBe(3);
    expect(dayjs("2022-08-31").financialMonth()).toBe(8);
  });
